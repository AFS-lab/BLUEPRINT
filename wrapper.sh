...
#This script takes the Kallisto counts matrix generated by running Kallisto on
#real data as input and generates a Splatter simulated gene expression counts matrix.
Rscript make_splatter.R

#This script renames the Gene1, Gene2 etc in the splatter matrix, calculates the
#TPM values, and uses polyester to simulate reads based on the counts values in
#the Splatter matrix
./control_polyester_script.sh

#This script uses bbmap to generate quality scores for the polyester generated fastas.
...
mv raw_results/data/ground_truth_TPM.txt raw_results/data/clean_ground_truth_TPM.txt
mv raw_results/data/ground_truth_counts.txt raw_results/data/clean_ground_truth_counts.txt
#
...
sed 's/chr//g' mm10_rRNA.bed > no_chr_mm10_rRNA.bed

./rRNA_contamination "SRR5237781" $path_to_java
./rRNA_contamination "SRR5237782" $path_to_java
./rRNA_contamination "SRR5237783" $path_to_java
