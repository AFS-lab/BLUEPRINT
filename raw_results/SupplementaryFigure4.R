...
write.table(QC_bias, "../figures/data/SupplementaryFigure4_reads_alignment_data.txt")
...
save(BLUEPRINT_Bs_scater_QC, file="../figures/data/SupplementaryFigure4_scater_object.RData")