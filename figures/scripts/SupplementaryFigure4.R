...
QC_raw<-read.table("../data/SupplementaryFigure4_reads_alignment_data.txt")
...
load("../data/SupplementaryFigure4_scater_object.RData")
...
ggsave("../pdfs/SupplementaryFigure4.pdf", plot=last_plot(),height = (6.04*1.5), width=(8.57*1.5))
ggsave("../pngs/SupplementaryFigure4.png", plot=last_plot(),height = (6.04*1.5), width=(8.57*1.5))